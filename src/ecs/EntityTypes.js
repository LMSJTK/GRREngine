...
export const ENTITY_TYPES = {
  npc: {
    ...
    schema: [
      ...
      { key: 'onInteract', label: 'On Interact (Script)', type: 'actionlist' },
    ],
  },
  enemy: {
    name: 'Enemy',
    ...
    schema: [
      ...
      { key: 'wanderRadius', label: 'Wander Radius', type: 'number', min: 16, max: 256 },
      { key: 'chaseRadius', label: 'Chase Radius', type: 'number', min: 16, max: 256 },
      { key: 'patrolDistance', label: 'Patrol Distance', type: 'number', min: 16, max: 256 },
      { key: 'direction', label: 'Facing', type: 'select', options: ['down', 'left', 'right', 'up'] },
      { key: 'spriteVariant', label: 'Sprite', type: 'sprite' },
      { key: 'onDefeat', label: 'On Defeat (Script)', type: 'actionlist' },
    ],
  },
  item: {
    name: 'Item',
  ...
  trigger: {
    ...
    schema: [
      ...
      { key: 'actions', label: 'Actions (Script)', type: 'actionlist' },
  ...
  door: {
    ...
    schema: [
      ...
      { key: 'actions', label: 'On Enter (Script)', type: 'actionlist' },
    ],
  },
};
